...
if (false) {
  ...
  //v- ca marche OK
  var Fct_ItChange_firstName = function Fct_ItChange_firstName() {
  ...
  //v- ca marche OK
  var Fct_ItChange_lastName = function Fct_ItChange_lastName() {
  ...
  //v- ca marche OK
  var Fct_ItChange_address = function Fct_ItChange_address() {
  ...
  //v- ca marche OK
  var Fct_ItChange_city = function Fct_ItChange_city() {
  ...
  //v- ca marche OK
  var Fct_ItChange_email = function Fct_ItChange_email() {
...
function Fct_ItFocusOut(iid_ccolor) {
  var itemQuantity = document.getElementById(iid_ccolor); // j- on écoute l'évenement hors champs // // On écoute l'événement focus OUT
